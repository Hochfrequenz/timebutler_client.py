...
class TestGetWorkdays:
    ...
    async def test_get_workdays_parses_csv_response(self) -> None:
        ...
        assert isinstance(result, WorkdaysResult)
        assert result.schedules == EXPECTED_SCHEDULES
        assert result.invalid_employees == []
    ...
    async def test_get_workdays_employee_number_comes_from_users(self) -> None:
        ...
        assert result.schedules[0].employee_number == "00123"  # user 928812
        assert result.schedules[2].employee_number == "00160"  # user 322219
        assert result.schedules[3].employee_number == "00042"  # user 300224
...
300224;Fischer;Clara;00042;;;;;;;Manager;de_DE;;false;;;"""
    ...
    async def test_get_workdays_multiple_entries_per_user(self) -> None:
        ...
        user_928812_entries = [s for s in result.schedules if s.user_id == 928812]
